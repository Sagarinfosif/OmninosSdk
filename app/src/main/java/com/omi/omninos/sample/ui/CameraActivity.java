package com.omi.omninos.sample.ui;
...
import com.omi.omninos.sample.data.BeautyItemData;
import com.omi.omninos.sample.util.FileDeleteAsyncTask;
...
import com.omi.omninos.sample.camera.ReferenceCamera;
import com.omi.omninos.sample.camera.ReferenceCamera1;
import com.omi.omninos.sample.camera.ReferenceCamera2;
import com.omi.omninos.sample.common.PermissionHelper;
import com.omi.omninos.sample.model.ItemModel;
import com.omi.omninos.sample.network.DownloadAsyncResponse;
import com.omi.omninos.sample.network.DownloadAsyncTask;
import com.omi.omninos.sample.rendering.CameraTexture;
import com.omi.omninos.sample.rendering.ScreenRenderer;
import com.omi.omninos.sample.util.MediaStoreUtil;
import com.omi.omninos.sample.util.PreferenceUtil;
import com.omi.omninos.sample.viewmodel.ContentsViewModel;
...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                mDataBinding.llLoading.setVisibility(View.GONE);
            }
        },10000);
        ...
        mMediaPath = Environment.getExternalStorageDirectory() + "/" + Environment.DIRECTORY_DCIM + "/OMNINOS";
        File dir = new File(mMediaPath);
        if (!dir.exists()) {
            dir.mkdirs();
        }
        mInnerMediaPath =  Objects.requireNonNull(getExternalFilesDir(null)).getAbsolutePath() + "/OMNINOSMedia";
